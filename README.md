...
Overall description: This repo provides the R script (run_analysis.R) to clean and summarize the Human Activity Recognition Using Smartphones Dataset
...
What is in the Human Activity Recognition Using Smartphones Dataset:
